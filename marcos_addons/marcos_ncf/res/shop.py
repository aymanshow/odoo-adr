...
class InvoiceJournalConfig(models.Model):
    ...
    sale = fields.Many2one("account.journal", u"Ventas (No comprobante)", required=False)
    final = fields.Many2one("account.journal", u"Consumidor final", required=False)
    ...
    gov = fields.Many2one("account.journal", u"Gubernalmentales", required=False)
