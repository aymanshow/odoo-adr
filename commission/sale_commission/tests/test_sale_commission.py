...
class TestSaleCommission(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.partner.write({'supplier': False, 'professional': False})
        professional_quaterly = self.res_partner_model.create({
            'name': 'Test Professional - Quaterly',
            'professional': True,
            'settlement': 'quaterly',
            'lang': 'en_US',
        })
        professional_semi = self.res_partner_model.create({
            'name': 'Test Professional - Semi-annual',
            'professional': True,
            'settlement': 'semi',
            'lang': 'en_US',
        })
        professional_annual = self.res_partner_model.create({
            'name': 'Test Professional - Annual',
            'professional': True,
            'settlement': 'annual',
            'lang': 'en_US',
        })
        ...
        self.saleorder1 = self.sale_order_model.create({
            ...
            'order_line': [(0, 0, {
                ...
                'product_uom_qty': 8.0,
                'professionals': [(0, 0, {
                    'professional': self.ref(
                        'sale_commission.res_partner_pritesh_sale_professional'),
                    'commission': self.ref(
        ...
        self.saleorder2 = self.sale_order_model.create({
            ...
            'order_line': [(0, 0, {
                ...
                'professionals': [(0, 0, {
                    'professional': professional_quaterly.id,
                    'commission': self.ref(
        ...
        self.saleorder3 = self.sale_order_model.create({
            ...
            'order_line': [(0, 0, {
                ...
                'product_uom_qty': 8.0,
                'professionals': [(0, 0, {
                    'professional': professional_semi.id,
        ...
        self.saleorder4 = self.sale_order_model.create({
            ...
            'order_line': [(0, 0, {
                ...
                'product_uom': self.ref('product.product_uom_dozen'),
                'professionals': [(0, 0, {
                    'professional': professional_annual.id,
    ...
    def test_res_partner_onchange(self):
        ...
        self.assertFalse(self.partner.professional)
        self.partner.professional = True
        self.partner.onchange_professional_type()
        self.assertTrue(self.partner.supplier)

    def test_sale_default_professional(self):
        sale_professional = self.browse_ref(
            'sale_commission.res_partner_pritesh_sale_professional')
        self.partner.professionals = [(6, 0, [sale_professional.id])]
        ...
        self.assertNotEquals(len(saleorder.mapped('order_line.professionals')), 0,
                             "There should be a professional assigned to the lines.")
        self.assertTrue(
            sale_professional in saleorder.mapped('order_line.professionals.professional'),
            "Sale professional in partner should be assigned in lines.")
