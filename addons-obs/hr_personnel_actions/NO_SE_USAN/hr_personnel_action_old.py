...
class HrPersonnelAction(osv.osv):
    ...
    _columns={
        ...
        'action_requeted_type': fields.selection((('designacion','Designacion'),
                                                  ('cambios','Cambios'),
                                                  ('salidas','Salidas'),
        ...
        'action_changes_requested':fields.selection((('1','Promocion'),                                     # hecho
                                                     ('2','Promocion y Transferencia'),                     # hecho
                                                     ('3','Reajuste de Sueldo'),                            # hecho
                                                     ('4','Reclasificacion'),
                                                     ('5','Transferencia')), 'Cambios', required=True),     # hecho
